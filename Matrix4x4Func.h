...
/// <returns></returns>
Matrix4x4 MakeRotateXYZMatrix(float Pitch, float Yaw, float Roll) {
	Matrix4x4 x = MakeRotateXMatrix(Pitch);
	Matrix4x4 y = MakeRotateYMatrix(Yaw);
	Matrix4x4 z = MakeRotateZMatrix(Roll);
